...
interface LeaveAnalytics {
  ...
  employeeLeaveData: { employee: string; leaves: number; department: string }[];
}
  ...
  return (
    <Box sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Alert 
        ...
        sx={{ mb: 3 }}
      >
        You have read-only access to employee and leave data. Contact Super Admin for modification permissions.
      </Alert>
      ...
      <Paper sx={{ mb: 3 }}>
        <Tabs value={tabValue} onChange={handleTabChange} variant="fullWidth">
          <Tab label="Day-wise Analytics" />
          <Tab label="Month-wise Analytics" />
          ...
          <Grid item xs={12}>
            <Paper sx={{ p: 3, height: 400 }}>
              <Typography variant="h6" gutterBottom>
                Daily Leave Trends (Last 30 Days) - Read Only
              </Typography>
              <Line 
                data={dailyLeavesChartData} 
                options={{ 
                  responsive: true, 
      ...
      {tabValue === 1 && (
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <Paper sx={{ p: 3, height: 400 }}>
              <Typography variant="h6" gutterBottom>
                Monthly Leave Trends - View Only
              </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Paper sx={{ p: 3, height: 400 }}>
              <Typography variant="h6" gutterBottom>
                Department Distribution - Read Only
              </Typography>
      ...
      {tabValue === 2 && (
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <Paper sx={{ p: 3 }}>
              <Typography variant="h6" gutterBottom>
                Employee Leave Data - Read Only Access
              </Typography>
              <TableContainer>
                <Table>
                  <TableHead>
                  ...
                  <TableBody>
                    {analytics.employeeLeaveData.map((employee, index) => (
                      <TableRow key={index}>
